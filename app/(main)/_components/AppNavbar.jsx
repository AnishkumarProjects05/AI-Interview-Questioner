...
import { Plus, LayoutDashboard, List, DockIcon, Menu, X, Moon, Sun } from 'lucide-react'
        ...
        <nav className="sticky top-0 z-50 w-full border-b border-slate-200 dark:border-white/10 bg-white/80 dark:bg-slate-950/80 backdrop-blur-xl font-inter">
            <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
                ...
                <div className="flex items-center gap-2 sm:gap-4">
                    ...
                    {/* User Avatar */}
                    <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-gradient-to-br from-indigo-500 to-violet-600 border-2 border-white dark:border-white/20 shadow-lg flex items-center justify-center text-white font-black text-xs cursor-pointer hover:scale-105 transition-transform">
                        {userInitial}
                    </div>
            ...
            <div 
                className={`
                    fixed top-0 right-0 h-full w-[280px] bg-white dark:bg-slate-950 border-l border-slate-200 dark:border-white/10 z-[110] p-8 space-y-8 shadow-2xl md:hidden
