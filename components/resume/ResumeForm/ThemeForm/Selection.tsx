import type { GeneralSetting } from "@/lib/resume/redux/settingsSlice";
import { PX_PER_PT } from "@/lib/resume/constants";
import {
  FONT_FAMILY_TO_STANDARD_SIZE_IN_PT,
  FONT_FAMILY_TO_DISPLAY_NAME,
  type FontFamily,
} from "@/components/resume/fonts/constants";
import { getAllFontFamiliesToLoad } from "@/components/resume/fonts/lib";
...
const Selection = ({
  ...
  return (
    <div
      className="flex w-[105px] text-gray-800 cursor-pointer items-center justify-center rounded-md border border-gray-300 py-1.5 shadow-sm hover:border-gray-400 hover:bg-gray-100"
      onClick={onClick}
