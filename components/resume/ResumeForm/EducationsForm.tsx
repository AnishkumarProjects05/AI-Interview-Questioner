...
import { changeEducations, selectEducations } from "@/lib/resume/redux/resumeSlice";
        ...
        return (
          ...
          >
            <Input
              ...
              name="school"
              placeholder="Ramco Insitute of technology"
              value={school}
              onChange={handleEducationChange as any}
            />
            <Input
              label="Date"
