import { BULLET_POINTS } from "@/lib/resume/parse-resume-from-pdf/extract-resume-from-sections/lib/bullet-points";
import { isBold } from "@/lib/resume/parse-resume-from-pdf/extract-resume-from-sections/lib/common-features";
import type { Lines, Line, Subsections } from "@/lib/resume/parse-resume-from-pdf/types";
